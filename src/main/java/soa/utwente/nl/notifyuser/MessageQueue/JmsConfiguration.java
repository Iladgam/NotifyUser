...
public class JmsConfiguration {
    ...
    public MessageConverter jaxbMarshaller() {
        ...
        jaxb2Marshaller.setPackagesToScan("soa.utwente.nl.notifyuser.integrations");
        jaxb2Marshaller.setSchemas(
                resourceLoader.getResource("classpath:xsd/IdResponse.xsd"),
                resourceLoader.getResource("classpath:xsd/IdTask.xsd")
        );
